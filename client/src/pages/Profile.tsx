    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-16 pb-16 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-secondary mb-4">Profile Not Found</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-16 pb-16 flex items-center justify-center">
        <div className="bg-white rounded-xl shadow-sm p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-2xl font-bold text-secondary mb-4">Profile Access</h1>
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div
            className="w-full h-48 bg-gradient-to-r from-secondary to-secondary-light"
            style={{
          ...
          <div className="p-6">
            <div className="flex flex-col sm:flex-row sm:items-end -mt-16 mb-4">
              <div
                className="w-32 h-32 rounded-full bg-white border-4 border-white shadow-md overflow-hidden"
                style={{
              ...
              <div className="mt-4 sm:mt-0 sm:ml-4 flex-grow">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <a
                    ...
                    className="ml-3 text-primary hover:text-primary-dark flex items-center text-sm"
                  >
          ...
          <Tabs defaultValue={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="created">
              {createdLoading ? (
                ...
                <div className="text-center py-16 bg-white rounded-xl">
                  <h3 className="text-xl font-bold text-secondary mb-2">No Created NFTs</h3>
            ...
            <TabsContent value="collected">
              {ownedLoading ? (
                ...
                <div className="text-center py-16 bg-white rounded-xl">
                  <h3 className="text-xl font-bold text-secondary mb-2">No Collected NFTs</h3>
                  <p className="text-gray-500 mb-6">
                    {isOwnProfile
            ...
            <TabsContent value="collections">
              {collectionsLoading ? (
                ...
                <div className="text-center py-16 bg-white rounded-xl">
                  <h3 className="text-xl font-bold text-secondary mb-2">No Collections</h3>
                  <p className="text-gray-500 mb-6">
                    {isOwnProfile
